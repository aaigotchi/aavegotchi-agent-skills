...
| Aavegotchi Traits | Fetch detailed Aavegotchi NFT data from Base chain: traits (BRS, Kinship, XP), wearables, stats, age. ID or name lookup with subgraph support. | https://github.com/aaigotchi/aavegotchi-traits |
